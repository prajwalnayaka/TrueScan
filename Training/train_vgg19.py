...
print("Loading pre-trained VGG19_BN model...")
model = models.vgg19_bn(weights=models.VGG19_BN_Weights.IMAGENET1K_V1)

# VGG19 has a '.classifier' section. We replace the VERY LAST layer of it.
# The final layer in the classifier block is at index [6].
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                best_acc = epoch_acc
                torch.save(model.state_dict(), 'vgg19_best.pt')
